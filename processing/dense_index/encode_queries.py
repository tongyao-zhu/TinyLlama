...
from pyserini.search.faiss import AutoQueryEncoder, TctColBertQueryEncoder, DprQueryEncoder
import json
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', type=str,
                        help='device cpu or cuda [cuda:0, cuda:1...]', default='cuda:0', required=False)
    args = parser.parse_args()
    device = args.device
    # topics = get_topics(args.topics)
    topics = {}
    # readjsonl lines, each line is a json dict
